...
```bash
sudo eselect repository add finskidomek git https://github.com
...
---
☕ *If you find Portager useful and want to support my work, consider [buying me a coffee](https://buymeacoffee.com).*
